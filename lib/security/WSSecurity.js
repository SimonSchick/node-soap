...
const { passwordDigest, getDate } = require('../utils');
...
class WSSecurity {
  constructor(username, password, options) {
    ...
    // Must account for backward compatibility for passwordType String param as well
    // as object options defaults: passwordType = 'PasswordText', hasTimeStamp = true
    ...
    if (!validPasswordTypes.includes(this._passwordType)) {
