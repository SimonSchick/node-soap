...
const TNS_PREFIX = utils.TNS_PREFIX;
const findPrefix = utils.findPrefix;
  ...
  constructor (definition, uri, options) {
    ...
    process.nextTick(function() {
      ...
      self.processIncludes(function(err) {
        ...
        const complexTypes = self.definitions.complexTypes;
        if (complexTypes) {
        ...
        const bindings = self.definitions.bindings;
      ...
      if (!objectName && top.name === 'Body' && name !== 'Fault') {
        ...
        if (!message) {
          try {
            ...
            const portTypes = self.definitions.portTypes;
